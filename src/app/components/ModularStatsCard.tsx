...
const ModularStatsCard: React.FC<ModularStatsCardProps> = ({
  ...
  return (
    <div className="relative h-full aspect-[16/10] bg-[#0A121E] border border-[#1B2A3B] rounded-xl p-6 shadow-lg hover:border-[#39FF14]/50 transition-all duration-300 group">
