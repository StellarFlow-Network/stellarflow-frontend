...
export const NAVIGATION_COMMANDS: readonly CommandItem[] = [
  ...
  },
  {
    ...
    keywords: ["pending", "speed up", "cancel", "export", "csv", "history"],
    iconId: ICON_IDS.history,
    href: "/dashboard/transactions",
  },
  {
    id: "page:bridge-refunds",
    kind: "page",
    title: "Bridge Refunds",
    subtitle: "/bridge/refunds",
    keywords: ["bridge", "refund", "unwrap", "cross-chain", "recovery"],
    iconId: ICON_IDS.network,
    href: "/bridge/refunds",
  },
  {
    id: "page:approval-audit",
    kind: "page",
    title: "Approval Audit",
    subtitle: "/security/approvals",
    keywords: ["allowance", "approval", "revoke", "unlimited", "security"],
    iconId: ICON_IDS.shieldAlert,
